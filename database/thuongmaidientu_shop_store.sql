...
INSERT INTO `shop_store` VALUES ('qcjxd','SHOP BÁN HÀNG',NULL,'2022-09-03 00:01:05',NULL,NULL,NULL,10),('TK','Thiên Khuyển','https://res.cloudinary.com/thuongmaidientu-tct-vvh/image/upload/v1662097651/d3gyeklxspmmzp48cxfr.png',NULL,2,5,3,5),('TT','Tống TiềnCCGGGG','https://res.cloudinary.com/thuongmaidientu-tct-vvh/image/upload/v1662277783/nf4dcmojdic6eu7hk2gz.png',NULL,7,8,2,3);
