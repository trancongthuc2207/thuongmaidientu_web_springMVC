...
CREATE TABLE `account_shop` (
  `id_account_s` varchar(25) NOT NULL,
  `username_s` varchar(25) NOT NULL,
  `password_s` varchar(25) NOT NULL,
  `id_pos` int DEFAULT NULL,
  PRIMARY KEY (`id_account_s`),
  KEY `id_pos_fk_s_idx` (`id_pos`),
  CONSTRAINT `id_pos_fk_s` FOREIGN KEY (`id_pos`) REFERENCES `position_staff` (`id_position`)
