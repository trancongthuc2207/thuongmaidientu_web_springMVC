...
INSERT INTO `type_product` VALUES (1,'Thực Phẩm','Sức khoẻ'),(2,'Điện Tử','Thông minh'),(3,'Thú Cưng','Các loại động vật '),(4,'Y Tế','Dụng cụ và thuốc '),(5,'Trang Sức','Làm đẹp'),(6,'Mỹ Phẩm','Làm đẹp');
