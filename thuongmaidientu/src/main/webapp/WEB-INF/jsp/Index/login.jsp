                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                    ...
                                    <form action="${url}" method="post" class="form-horizontal auth-form">
                                ...
                                <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                    ...
                                    <form:form class="form-horizontal auth-form was-validated" action="${register}" method="POST" modelAttribute="account">
                                        <div class="form-group">
                                            <form:input path="usernameC" required="required" name="username" type="text"
                                                   class="form-control is-invalid" placeholder="Username"
                                                        id="exampleInputEmail12"/>
                                        </div>
                                        <div class="form-group">
                                            <form:input path="passwordC" required="required" name="password" type="password"
                                                   class="form-control" placeholder="Password"/>
                                        </div>
                                        <div class="form-group">
                                            <form:input path="confirmPassword" required="required" name="password" type="password"
                                                   class="form-control is-invalid" placeholder="Confirm Password"/>
                                        </div>
                                        <div class="form-group type_pro">
                                            <label style="width: 30%; text-align: right; margin-right: 15px">Loại tài khoản:</label>
                                            <form:select style="width: 40%;" id="idPos" path="idPos" class="form-select is-invalid" required="required">
                                                <option value="2" selected>Khách hàng</option>
                                                <option value="3">Cửa hàng</option>
                                                <option value="4">Nhân viên App</option>
                                            </form:select>
                                        </div>
                                        <form:input style="width: 40%; display: none;" type="text" class="form-control is-invalid" path="stt"/>
                                        <div class="form-terms">
                                            <div class="form-check mesm-2">
                                                <input type="checkbox" class="form-check-input"
...
<script src="${ass1}js/jquery-3.3.1.min.js"></script>

<!-- Bootstrap js-->
<script src="${ass1}js/bootstrap.bundle.min.js"></script>

<!-- feather icon js-->
<script src="${ass1}js/icons/feather-icon/feather.min.js"></script>
<script src="${ass1}js/icons/feather-icon/feather-icon.js"></script>

<!-- Sidebar jquery-->
<script src="${ass1}js/sidebar-menu.js"></script>
<script src="${ass1}js/slick.js"></script>

<!-- lazyload js-->
<script src="${ass1}js/lazysizes.min.js"></script>

<!--right sidebar js-->
<script src="${ass1}js/chat-menu.js"></script>

<!--script admin-->
<script src="${ass1}js/admin-script.js"></script>
<script>
    $('.single-item').slick({
        arrows: false,
        dots: true
