    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="${ass}images/home-banner/1.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <div>
            <div class="home text-center">
                <img src="${ass}images/home-banner/2.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
...
<div class="title1 section-t-space">
    <h2 class="title-inner1">dành cho bạn</h2>
</div>
            ...
            <div class="col">
                <div class="theme-tab">
                    <ul class="tabs tab-title">
                        <li class="current"><a href="tab-4">Tất cả</a></li>
                        <li class=""><a href="tab-5">đang giảm giá</a></li>
                        <li class=""><a href="tab-6">gợi ý cho bạn</a></li>
                    </ul>
                    <div class="tab-content-cls">
                                        ...
                                        <div class="img-wrapper">
                                            ...
                                            <div class="cart-info cart-wrap">
                                                <sec:authorize access="hasAnyRole('ROLE_USER')">
                                                    <button onclick="clickAddCartPro(${idOr},${p.idProduct},'${idCust}')"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-sm-12">
                                                <nav aria-label="Page navigation">
                                                    <ul class="pagination">
                                                        <c:forEach begin="1" end="${Math.ceil(productCounter/8)}"
                                                                   var="i">
                                                            <c:url value="/" var="c">
                                                                <c:param value="${i}" name="page"/>
                                                                <c:if test="${checkSearch == true}">
                                                                    <c:param value="${kwAll}" name="kwAll"/>
                                                                    <c:param value="${isDiscount}" name="isDiscount"/>
                                                                    <c:param value="${incre_des}" name="incre_des"/>
                                                                </c:if>
                                                            </c:url>
                                            ...
                                            <div class="col-xl-6 col-md-6 col-sm-12">
                                                <nav aria-label="Page navigation">
                                                    <ul class="pagination">
                                                        <c:forEach begin="1" end="${Math.ceil(productCounter/8)}"
                                                                   var="i">
                                                            <c:url value="/" var="c_type">
                                                                <c:param value="${type}" name="type_Id"/>
                                                                <c:param value="${i}" name="page"/>
                                                            </c:url>
                                                            <li class="page-item"><a class="page-link"
                                                                                     href="${c_type}">${i}</a></li>
                        ...
                        <div id="tab-6" class="tab-content">
                            <div class="no-slider row">
                                <c:forEach items="${lstProductFavor}" var="p">
                                    <c:url value="/products/" var="cUrl">
                                        <c:param name="ID_Product" value="${p.idProduct}"/>
                                    </c:url>
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <c:if test="${p.image.startsWith('https') == false}">
                                                    <img
                                                         class="img-fluid blur-up lazyload bg-img" class="img-fluid"
                                                         src="https://res.cloudinary.com/dxxwcby8l/image/upload/v1647248722/r8sjly3st7estapvj19u.jpg"
                                                         alt="Card image">
                                                </c:if>
                                                <c:if test="${p.image.startsWith('https') == true}">
                ...
                <div class="slide-6 no-arrow">
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/1.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/2.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/3.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/4.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/5.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/6.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/7.png" alt=""></a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#"><img src="${ass}images/logos/8.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
