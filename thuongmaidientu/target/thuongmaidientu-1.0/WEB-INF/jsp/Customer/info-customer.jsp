...
<%--                                        &lt;%&ndash;                                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin"&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                         class="rounded-circle" width="150">&ndash;%&gt;--%>
...
<%--                                                path="nameC"--%>
<%--                                                value="${in4.nameC}" required="required"/>--%>
...
<%--                                            path="sex" class="form-selec editCusSex" required="required">--%>
...
<%--                                                class="col-sm-9 text-secondary form-control editCus"--%>
<%--                                                path="serialNumberC"--%>
<%--                                                value="${in4.serialNumberC}" required="required"/>--%>
<%--                                </div>--%>
<%--                                <hr>--%>
<%--                                <div class="row">--%>
<%--                                    <div class="col-sm-3">--%>
...
<%--                                                class="col-sm-9 text-secondary form-control editCus"--%>
<%--                                                path="phoneNumber"--%>
<%--                                                value="${in4.phoneNumber}" required="required"/>--%>
<%--                                        &lt;%&ndash;                                <div class="col-sm-9 text-secondary">&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                    +84344564075&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                                </div>--%>
<%--                                <hr>--%>
<%--                                <div class="row">--%>
...
<%--                                    </div>--%>
<%--                                    <form:input style="width: 100%;" type="text"--%>
<%--                                                class="col-sm-9 text-secondary form-control editCus address"--%>
<%--                                                path="address"--%>
<%--                                                value="${in4.address}" required="required"/>--%>
<%--                                    <div class="select-address">--%>
<%--                                        <select onchange="listProvinceOnchange()" class="province"--%>
<%--                                                name="ls_province"></select>--%>
<%--                                        <select onchange="listDistrictOnchange()" class="district"--%>
<%--                                                name="ls_district"></select>--%>
<%--                                        <select onchange="listWardOnchange()" class="ward" name="ls_ward"></select>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                                <div>--%>
...
<%--                                    </button>--%>
<%--                                        &lt;%&ndash;  SAVE BUTTON  &ndash;%&gt;--%>
<%--                                        &lt;%&ndash;  CANCLE BUTTON  &ndash;%&gt;--%>
<%--                                    <button type="button" onclick="cancleCusEdit()"--%>
<%--                                            style="color: red;margin-left: 30px;font-size: 20px; display: none"--%>
<%--                                            class="btn fa-solid fa-xmark edit cancle"> Huỷ--%>
<%--                                    </button>--%>
<%--                                        &lt;%&ndash;  CANCLE BUTTON  &ndash;%&gt;--%>
<%--                                </div>--%>
<%--                            </div>--%>
...
<%--            <form:input path="idAccount" style="width: 200px;height: 25px" type="text" cssStyle="display: none"--%>
<%--                        value="${idAcc}"/>--%>
...
<%--                                                    <td>--%>
<%--                                                        <a href="javascript:void(0)">--%>
<%--                                                            <img src="${ass}images/pro3/27.jpg"--%>
<%--                                                                 class="blur-up lazyloaded" alt="">--%>
<%--                                                        </a>--%>
<%--                                                    </td>--%>
<%--                                                    <td>--%>
...
<%--                                                    <td>--%>
<%--                                                        <a href="javascript:void(0)">--%>
<%--                                                            <img src="${ass}images/pro3/28.jpg"--%>
<%--                                                                 class="blur-up lazyloaded" alt="">--%>
<%--                                                        </a>--%>
<%--                                                    </td>--%>
<%--                                                    <td>--%>
...
<%--                                                    <td>--%>
<%--                                                        <a href="javascript:void(0)">--%>
<%--                                                            <img src="${ass}images/pro3/33.jpg"--%>
<%--                                                                 class="blur-up lazyloaded" alt="">--%>
<%--                                                        </a>--%>
<%--                                                    </td>--%>
<%--                                                    <td>--%>
...
<%--                                                    <td>--%>
<%--                                                        <a href="javascript:void(0)">--%>
<%--                                                            <img src="${ass}images/pro3/34.jpg"--%>
<%--                                                                 class="blur-up lazyloaded" alt="">--%>
<%--                                                        </a>--%>
<%--                                                    </td>--%>
<%--                                                    <td>--%>
...
<script>
    ...
    function listProvinceOnchange() {
        ...
        console.log(addr)
        address_full.setAttribute("value", addr)
    }
